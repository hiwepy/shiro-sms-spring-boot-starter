...
**Spring Boot Starter for shiro-sms**

[![Maven Central](https://img.shields.io/maven-central/v/io.github.easy4j/shiro-sms-spring-boot-starter)](https://github.com/easy-4-java/shiro-sms-spring-boot-starter)
...
> **Artifact ID**：`shiro-sms-spring-boot-starter`<br>
> **License**：Apache License 2.0<br>

## 1. Positioning

**shiro-sms-spring-boot-starter** is a Spring Boot starter that integrates **shiro-sms** for applications using shiro-sms. It provides auto-configuration, property binding, and ready-to-use beans so that applications can consume shiro-sms capabilities with minimal setup.

| Dimension | Description |
|---|---|
| Type | Spring Boot Starter |
| Consumers | Spring Boot applications using shiro-sms |
| Core Capabilities | auto-configuration, property binding, ready-to-use beans for shiro-sms |
| JDK | `17` |
| Coordinates | `io.github.easy4j:shiro-sms-spring-boot-starter:1.0.0-SNAPSHOT` |
| Config Prefix | `shiro.sms` |

## 2. Core Capabilities

| Capability | Status | Description |
|---|:---:|---|
| Auto-configuration | ✅ Stable | Registers shiro-sms beans automatically |
| Property Binding | ✅ Stable | Binds `shiro.sms.*` to `ShiroSmsProperties` |
| Ready-to-use beans | ✅ Stable | Auto-registered via ShiroSmsWebAutoConfiguration |
...
|---|---|---|:---:|---|:---:|
| `shiro.sms.enabled` | boolean | `true` | No | Enable the starter | No |
...
```bash
mvn clean verify
mvn -pl shiro-sms-spring-boot-starter -am test
```
...
|---|---|---|
| Bean not created | Check auto-configuration report | Verify `shiro.sms.enabled=true` and classpath |
...
[Back to top](#readme-top) · [Issues](https://github.com/easy-4-java/shiro-sms-spring-boot-starter/issues) · [Repository](https://github.com/easy-4-java/shiro-sms-spring-boot-starter)
